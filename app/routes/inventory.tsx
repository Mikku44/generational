...
import { inventoryData } from "~/data/InventoryRepo";
...
export function meta({ }: Route.MetaArgs) {
  return [
    ...
    {
      property: "og:image",
      content: "https://generational-eta.vercel.app/inventory/ferrari/1.jpg", // update if you have one
    },
    ...
    {
      name: "twitter:image",
      content: "https://generational-eta.vercel.app/inventory/ferrari/1.jpg",
    },
  ];
}
  ...
  return (
    <main className="min-h-screen w-full mb-20">
      ...
      <div className="container-x grid md:gap-24 gap-10 md:mt-[220px]  mt-[200px]">
        {inventoryData.map((item,index)=><InventoryCard 
        key={index}
        index={index}
        item={item}  />)}
      </div>
